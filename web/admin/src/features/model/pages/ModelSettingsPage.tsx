...
export function ModelSettingsPageContent({ status }: { status: CapabilityStatus }) {
  ...
  return <Stack spacing={3}>
    <Stack direction="row" alignItems="center"><Typography component="h2" variant="h5" fontWeight={750} sx={{ flexGrow: 1 }}>模型设置</Typography><Button variant="contained" disabled={!enabled}>新增模型</Button></Stack>
