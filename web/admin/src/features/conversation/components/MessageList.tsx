...
export function MessageList({ messages, knowledgeBaseId, streamingAnswer, agentRunState, agentRunId, agentRunStates, pendingRunIds, retryingMessageId, resumingRun, emptyComposer, onSuggestion, onRetry, onSwitchVersion }: {
  messages: Message[];
