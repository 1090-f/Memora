...
type Document struct {
	...
	IndexBuildOwner     *string    `gorm:"column:index_build_owner" json:"-"`                                 // IndexBuildOwner 当前候选索引的任务令牌
	IndexBuildVersion   *int       `gorm:"column:index_build_version" json:"-"`                               // IndexBuildVersion 当前任务拥有的候选索引版本
